...
const BLOG = {
  ...
  PRISM_THEME_LIGHT_PATH:
    ...
    'https://cdn.jsdelivr.net/npm/prismjs@1.9.0/themes/prism-one-light.min.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://cdn.jsdelivr.net/npm/prismjs@1.9.0/themes/prism-one-dark.min.css', // 深色模式主题
